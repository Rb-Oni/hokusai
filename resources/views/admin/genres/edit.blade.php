    ...
    <div class="py-12 px-5">
        ...
        <div class="w-full mt-4 lg:w-5/6 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('genres.update', $genre) }}" method="POST">
                ...
                <a href="{{ route('admin.genres.index') }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
