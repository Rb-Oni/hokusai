                ...
                <table class="min-w-max w-full table-auto">
                    <thead class="">
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th class="py-3 px-6 text-center">Référence</th>
                            <th class="py-3 px-6 text-center">Taille</th>
                            <th class="py-3 px-6 text-center">URL SumUp</th>
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                ...
                                <span class="text-red-500 font-bold flex items-center justify-center">
                            ...
                            <td class="py-3 px-6 text-center">
                                ...
                                @else
                                <span><a href="{{ $product->url }}" target="_blank" class="text-green-500 font-bold">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
