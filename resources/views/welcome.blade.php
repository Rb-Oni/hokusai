...
<div class="container mx-auto xl:h-45vh flex justify-end items-end">
    <div class="hidden xl:block w-32rem px-6 py-8 bg-white bg-opacity-95 hover:bg-black hover:bg-opacity-95 hover:text-white duration-150">
        <a href="{{ route('mangas.show', str_replace(' ', '+', 'My Hero Academia')) }}" class="text-3xl">
...
<div class="container mx-auto py-16">
    ...
    <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'L\'attaque des Titans')) }}" class="group">
            ...
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'Berserk')) }}" class="group">
            ...
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'One Piece')) }}" class="group">
            ...
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'Tokyo Ghoul')) }}" class="group">
    ...
    <section class="my-16">
        ...
        <div class="grid lg:grid-flow-col gap-4">
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'Solo Leveling')) }}" class="group flex text-white h-60 font-bold bg-cover bg-sl">
            ...
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'Demon Slayer')) }}" class="group flex text-white h-60 lg:h-31rem font-bold bg-cover bg-kny row-span-2">
                <div class="flex invisible group-hover:visible duration-150 group-hover:animate-news m-auto h-14 w-full bg-black bg-opacity-95">
                    <p class="text-3xl m-auto">Demon Slayer</p>
                </div>
            </a>
            <a href="{{ route('mangas.show', str_replace(' ', '+', 'Haikyu !!')) }}" class="group flex text-white h-60 font-bold bg-cover bg-haikyu">
                <div class="flex invisible group-hover:visible duration-150 group-hover:animate-news m-auto h-14 w-full bg-black bg-opacity-95">
                    <p class="text-3xl m-auto">Haikyu !!</p>
                </div>
            </a>
