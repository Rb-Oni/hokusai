...
<div class="xl:bg-mha xl:bg-cover xl:bg-top">
    ...
    <div class="bg-manga bg-cover bg-top">
        ...
        <div class="bg-manga bg-cover bg-center">
            @endif

            <div class="container-fluid relative bg-white bg-opacity-95 text-black {{  Route::is('welcome') || Route::is('mangas.index') || Route::is('search')  ? '' : 'border-b-4 border-black'  }}">
                <div x-data="{ open: true }" class="flex flex-col pr-4 lg:items-end lg:justify-between lg:flex-row lg:pr-12">
                    ...
                    <nav :class="{'flex': open, 'hidden': !open}" class="hidden mx-5 pb-2 xl:block">
                        <form action="{{ route('search') }}" method="GET" class="bg-gray-100 px-2 flex items-center">
                            ...
                            <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <nav :class="{'flex': open, 'hidden': !open}" class="flex-grow hidden mx-5 pb-4 lg:pb-2 lg:flex lg:justify-end flex-row">
                        <a class="hover:text-greenc mr-4" href="{{ route('cart') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                            </svg>
                        </a>
                        <a class="hover:text-greenc" href="{{ route('profile') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
